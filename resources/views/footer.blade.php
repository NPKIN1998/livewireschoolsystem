 <footer
     ...
     <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023
         <a href="{{ route('welcome') }}" class="hover:underline">Must University™</a>. All Rights Reserved.
     </span>
     <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
         <li>
             <a href="{{ route('welcome') }}" class="hover:underline me-4 md:me-6">Home</a>
         </li>
         <li>
             <a href="{{ route('schools') }}" class="hover:underline me-4 md:me-6">Schools</a>
         </li>
     </ul>
 </footer>
